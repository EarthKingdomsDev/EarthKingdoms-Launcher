...
const refreshMojangStatuses = async function(){
    loggerLanding.log('Rafraîchissement des Status Mojang...')
    ...
    if(response.responseStatus === RestResponseStatus.SUCCESS) {
        ...
        loggerLanding.warn('Impossible de rafraîchir les Status Mojang.')
    ...
    sysAEx.on('message', (m) => {
        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    'Aucune version compatible de<br>Java n\'a été trouvé !',
                    'Pour pouvoir jouer à FallenGlory, il vous faut Java 8 x64. Voulez-vous l\'installer ?',
                    'Installer Java',
                ...
                setDismissHandler(() => {
                    $('#overlayContent').fadeOut(250, () => {
                        ...
                        setOverlayContent(
                            ...
                            'Il vous faut Java 8 x64 pour jouer.<br><br>Veuillez vous référer au <a href="https://github.com/dscalzi/HeliosLauncher/wiki/Java-Management#manually-installing-a-valid-version-of-java">Guide de gestion Java</a> pour obtenir des instructions sur l\'installation manuelle de Java.',
                            'Je comprends',
                            'Retour'
                        )
                        setOverlayHandler(() => {
        ...
        if(m.context === 'validate'){
            switch(m.data){
                ...
                case 'libraries':
                    ...
                    setLaunchDetails('Validation du fichier divers...')
                    break
                case 'files':
            ...
            if(login && allGood) {
                ...
                try {
                    ...
                    setLaunchDetails('Le jeu a été lancer !')
